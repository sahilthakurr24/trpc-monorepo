...
ALTER TABLE "form_fields" ADD CONSTRAINT "form_fields_form_id_form_id_fk" FOREIGN KEY ("form_id") REFERENCES "public"."form"("id") ON DELETE no action ON UPDATE no action;